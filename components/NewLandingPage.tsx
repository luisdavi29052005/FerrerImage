...
const NewLandingPage: React.FC<NewLandingPageProps> = ({ onGetStarted }) => {
    ...
    return (
        <div className="w-full bg-vintage-paper">
            ...
            <section id="upload" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="max-w-4xl mx-auto">
                    <h2 className="font-display text-4xl md:text-5xl text-brand-brown text-center mb-8">
                        Comece sua viagem no tempo
                    </h2>
                    <p className="text-center font-body text-xl text-brand-brown/80 mb-12">
                        Siga estes passos simples para transformar sua foto:
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                        <div className="bg-white rounded-lg p-6 shadow-md text-center">
                            <div className="w-16 h-16 bg-brand-blue/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="font-display text-3xl text-brand-blue">1</span>
                            </div>
                            <h3 className="font-body font-bold text-lg text-brand-brown mb-2">Escolha sua foto</h3>
                            <p className="font-body text-sm text-brand-brown/70">
                                Clique no botão abaixo ou arraste uma foto clara do seu rosto
                            </p>
                        </div>
                        <div className="bg-white rounded-lg p-6 shadow-md text-center">
                            <div className="w-16 h-16 bg-brand-blue/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="font-display text-3xl text-brand-blue">2</span>
                            </div>
                            <h3 className="font-body font-bold text-lg text-brand-brown mb-2">Veja a prévia grátis</h3>
                            <p className="font-body text-sm text-brand-brown/70">
                                Aguarde 2-3 minutos enquanto geramos suas 6 versões
                            </p>
                        </div>
                        <div className="bg-white rounded-lg p-6 shadow-md text-center">
                            <div className="w-16 h-16 bg-brand-blue/20 rounded-full flex items-center justify-center mx-auto mb-4">
                                <span className="font-display text-3xl text-brand-blue">3</span>
                            </div>
                            <h3 className="font-body font-bold text-lg text-brand-brown mb-2">Pague e receba</h3>
                            <p className="font-body text-sm text-brand-brown/70">
                                Digite seu email no checkout e receba as imagens sem marca d'água
                            </p>
                        </div>
                    </div>

                    {/* Área de Upload */}
                    <div className="bg-white rounded-lg shadow-xl p-8 border-2 border-brand-blue/30">
                        ...
                        <div className="border-2 border-dashed border-brand-brown/30 rounded-lg p-12 text-center bg-vintage-paper/30 hover:bg-vintage-paper/50 hover:border-brand-brown transition-all cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-brand-brown/50 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                            <button
                                onClick={onGetStarted}
                                className="font-body text-lg bg-brand-brown text-vintage-paper px-8 py-3 rounded-md hover:bg-opacity-90 transition-all shadow-md mb-2"
                            >
                                Selecionar Foto
                            </button>
                            <p className="font-body text-sm text-brand-brown/60 mt-3">
                                ou arraste e solte aqui
                            </p>
                        </div>

                        {/* Dicas */}
                        <div className="mt-6 bg-brand-blue/5 rounded-lg p-4">
