...
const Footer = () => {
    ...
    return (
        <footer className="fixed bottom-0 left-0 right-0 bg-vintage-paper/80 backdrop-blur-sm p-3 z-50 text-brand-brown/80 text-xs sm:text-sm border-t border-brand-brown/20 font-body">
            <div className="max-w-screen-xl mx-auto flex justify-between items-center gap-4 px-4">
                {/* Left Side */}
                <div className="hidden md:flex items-center gap-4 text-brand-brown/60 whitespace-nowrap">
                    <p>Powered by Gemini 2.5 Flash Image Preview</p>
                    <span className="text-brand-brown/30" aria-hidden="true">|</span>
                    <p>
                        Created by{' '}
                        <a
                            href="https://www.facebook.com/profile.php?id=100085172238508"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-brand-brown/90 hover:text-brand-orange transition-colors duration-200"
                        >
                            @Duda Ferrer 
                        </a>
                    </p>
                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    <div className="hidden lg:flex items-center gap-2 text-brand-brown/70 text-right min-w-0">
                        ...
                        <div className="relative w-64 h-5">
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className="absolute inset-0 font-medium text-brand-brown whitespace-nowrap text-left"
                                >
                                    {REMIX_IDEAS[index]}
                                </motion.span>
                            </AnimatePresence>
